...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .requestMatchers(HttpMethod.GET,"/api/public/login/oauth2/code/google").permitAll()
                ...
                .requestMatchers(HttpMethod.GET,"/api/readers/recommendation").hasRole(Role.READER)
                //end readers
                //genres
                ...
                .requestMatchers(HttpMethod.GET,"/api/readers/recommendation2").permitAll()
                //end lendings
