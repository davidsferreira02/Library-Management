...
public class Bootstrapper implements CommandLineRunner {
    ...
    private void createAuthors() {
        if (authorRepository.searchByNameName("Manuel Antonio Pina").isEmpty()) {
            final Author author = new Author(idGenerator.generateUniqueHex24(),"Manuel Antonio Pina",
                    "Manuel António Pina foi um jornalista e escritor português, premiado em 2011 com o Prémio Camões",
                    null);
            authorRepository.save(author);
        }
        if (authorRepository.searchByNameName("Antoine de Saint Exupéry").isEmpty()) {
            final Author author = new Author(idGenerator.generateUniqueHex24(), "Antoine de Saint Exupéry",
        ...
        if (authorRepository.searchByNameName("Alexandre Pereira").isEmpty()) {
            final Author author = new Author(idGenerator.generateUniqueHex24(), "Alexandre Pereira",
        ...
        if (authorRepository.searchByNameName("Filipe Portela").isEmpty()) {
            final Author author = new Author(idGenerator.generateUniqueHex24(), "Filipe Portela",
        ...
        if (authorRepository.searchByNameName("Ricardo Queirós").isEmpty()) {
            final Author author = new Author(idGenerator.generateUniqueHex24(), "Ricardo Queirós",
        ...
        if (authorRepository.searchByNameName("Freida Mcfadden").isEmpty()) {
            final Author author = new Author(idGenerator.generateUniqueHex24(), "Freida Mcfadden",
        ...
        if (authorRepository.searchByNameName("J R R Tolkien").isEmpty()) {
            final Author author = new Author(idGenerator.generateUniqueHex24(), "J R R Tolkien",
        ...
        if (authorRepository.searchByNameName("Gardner Dozois").isEmpty()) {
            final Author author = new Author(idGenerator.generateUniqueHex24(), "Gardner Dozois",
        ...
        if (authorRepository.searchByNameName("Lisa Tuttle").isEmpty()) {
            final Author author = new Author(idGenerator.generateUniqueHex24(), "Lisa Tuttle",
